...
import { CrbNavItemComponent } from './crb-lib-nav-item/crb-lib-nav-item';
import { Routes } from '@angular/router';

@Component({
  selector: 'nav[CrbNav]',
  standalone: true,
  imports: [CrbIcons, CrbNavItemComponent],
  templateUrl: './crb-lib-nav.html',
  styleUrl: './crb-lib-nav.scss',
})
export class CrbNav implements OnInit, OnDestroy {
